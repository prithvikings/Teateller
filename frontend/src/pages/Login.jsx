      ...
      <div className="w-full max-w-sm flex flex-col items-center">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[13px] text-linear-text-muted">
            The safest place to spill your deepest secrets.
          </p>
        </div>
        ...
        <div className="w-full p-6 rounded-2xl border border-linear-border bg-black/[0.02] dark:bg-white/[0.02] shadow-sm mb-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-linear-text text-linear-bg py-2.5 rounded-lg text-[13px] font-semibold hover:opacity-90 transition-opacity shadow-sm"
          >
        ...
        <div className="flex items-start gap-3 max-w-xs bg-emerald-500/10 border border-emerald-500/20 p-3 rounded-lg text-emerald-600 dark:text-emerald-400">
          ...
          <p className="text-[11px] leading-relaxed font-medium">
            We use Google strictly for spam prevention. Your email is hashed and
            never linked to your public confessions or alias.
          </p>
        </div>
      </div>
    </div>
